...
const HomeScreen: React.FC<HomeScreenProps> = ({ navigateTo, astronautData, onDailyCheckIn, missionTasks, onDataRefresh }) => {
    ...
    const handleCheckInSubmit = (mood: Mood, sleep: SleepQuality) => {
        onDailyCheckIn(mood, sleep);
    };
    ...
    return (
        <div className="space-y-6 animate-fade-in">
            ...
            <EarthlinkModal isOpen={isEarthlinkModalOpen} onClose={() => setIsEarthlinkModalOpen(false)} message={activeMessage} onMessageViewed={handleMessageViewed} />
        </div>
    );
};
